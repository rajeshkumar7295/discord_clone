...
import { MoreVertical, ShieldAlert, ShieldCheck, ShieldQuestion, Shield, Check, Gavel, Loader2 } from "lucide-react";
...
const roleIconMap = {
    "GUEST": null,
    "MODERATOR": <ShieldCheck className="h-4 w-4 ml-4 text-indigo-500" />,
